...
class VAF:
    ...
    def tcs(self,lpf=0):
        ...
        #First charge state data
        #self.ldata[0][1] = S.cntIO[0]
        #self.ldata[0][2] = S.cntIO[2]
        #self.ldata[0][3] = S.cntIO[4]
        #self.ldata[0][4] = numpy.sqrt(S.envIO[0][0])
        #self.ldata[0][5] = numpy.sqrt(S.envIO[2][2])
        ...
        for i in range(1,len(self.M)):
            ...
            #First charge state data
            #self.ldata[i][1] = S.cntIO[0]
            #self.ldata[i][2] = S.cntIO[2]
            #self.ldata[i][3] = S.cntIO[4]
            #self.ldata[i][4] = numpy.sqrt(S.envIO[0][0])
            #self.ldata[i][5] = numpy.sqrt(S.envIO[2][2])
    ...
    def tcs_seg(self,start,end,SD=None):
        ...
        rdata[0][6] = S.ref_phis - SD.refphis
        ...
        for (j,i) in enumerate(range(start,end)):
            ...
            rdata[j+1][6] = S.ref_phis - SD.refphis
...
class SaveBeam:
    def __init__(self,S_in):
        ...
        self.realphis = S_in.real_phis
        
        self.BC0      = S_in.cntIO
        self.ENV0     = S_in.envIO
